            ...
            if cell_type == 'n':
                ...
                if not tvalue:
                    if self.bk.formatting_info:
                        self.sheet.put_cell(rowx, colx, XL_CELL_BLANK, '', tvalue, xf_index)
                else:
                    self.sheet.put_cell(rowx, colx, None, float(tvalue), tvalue, xf_index)
            elif cell_type == "s":
                ...
                if not tvalue:
                    ...
                    self.sheet.put_cell(rowx, colx, XL_CELL_TEXT, value, tvalue, xf_index)
            elif cell_type == "str":
                ...
                self.sheet.put_cell(rowx, colx, XL_CELL_TEXT, tvalue, tvalue, xf_index)
            elif cell_type == "b":
                # b = boolean
                ...
                for child in cell_elem:
                    ...
                    if child_tag == V_TAG:
                        ...
                        bad_child_tag(child_tag)
                self.sheet.put_cell(rowx, colx, XL_CELL_BOOLEAN, cnv_xsd_boolean(tvalue), tvalue, xf_index)
            elif cell_type == "e":
                # e = error
                ...
                self.sheet.put_cell(rowx, colx, XL_CELL_ERROR, value, tvalue, xf_index)
